...
class ProduitFormTest(TestCase):
    def test_form_valid_data(self):
        form = ProduitForm(data = {'intituleProd': 'ProduitPourTest', 'prixUnitaireProd': '59.99', 'dateFabricationProd': '2025-09-09'})
    ...
    def test_form_save(self):
        form = ProduitForm(data = {'intituleProd': 'ProduitPourTest', 'prixUnitaireProd': '58.99', 'dateFabricationProd': '2025-09-09'})
