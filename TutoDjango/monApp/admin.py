...
class ProduitAdmin(admin.ModelAdmin):
    model = Produit
    list_display = ["refProd", "intituleProd", "prixUnitaireProd", "prixTTCProd", "dateFabricationProd", "categorie", "status"]
    list_editable = ["intituleProd", "prixUnitaireProd", "dateFabricationProd", "status"]
    radio_fields = {"status": admin.VERTICAL}
    search_fields = ('intituleProd', 'dateFabricationProd')
    list_filter = (ProduitFilter,)
    date_hierarchy = 'dateFabricationProd'
    ordering = ('-dateFabricationProd',) # ordre décroissant avec le -
